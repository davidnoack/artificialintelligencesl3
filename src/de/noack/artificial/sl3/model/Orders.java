...
public class Orders {
    ...
    public void order(Item itemToOrder) {
        if (itemToOrder.getParentStock().isEnoughSpaceFor(itemToOrder.getSize())) {
            itemToOrder.getOrderRule().decreaseStockOverflow();
            ...
            itemToOrder.getOrderRule().increaseStockOverflow();
        }
    }
}